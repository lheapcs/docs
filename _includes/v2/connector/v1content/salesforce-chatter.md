...
Register for a free Salesforce developer account or log into your existing Salesforce account. 

You can use any Salesforce account to create a Connected App. It doesn't have to be a developer account.
...
**API Name:** defaults to the same value as your Connected App Name
